...
SELECT "norrænt vörunúmer" AS product_number,
       ...
       "hámarks heildsöluverð" AS maximum_wholesale_price,
       "hámarks smásöluverð" AS maximum_retail_price,
       ...
       "umboðsmanna heildsöluverð" AS distributor_wholesale_price,
       "heildsölu heildsöluverð" AS total_wholesale_price,
       "innkaupsverð apóteka" AS pharmacy_purchase_price,
       "greiðsluþátttökuverð" AS co_payment_price,
